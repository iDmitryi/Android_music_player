...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (actionName != null){
            switch (actionName){
                case "playPause":
                    playPauseBtnClickedMethod();
                    break;
                case "next":
                    nextBtnClickedMethod();
                    break;
                case "previous":
                    prevBtnClickedMethod();
                    break;
            }
        }
        return START_STICKY;
    ...
    void showNotification(int playPlauseBtn){
    ...
    void playPauseBtnClickedMethod(){
        if (actionPlaying != null){
            actionPlaying.playPauseBtnClicked();
        }
    }

    void prevBtnClickedMethod(){
        if(actionPlaying != null){
            actionPlaying.prevBtnClicked();
        }
    }

    void nextBtnClickedMethod(){
        if (actionPlaying != null){
            actionPlaying.nextBtnClicked();
        }
    }
